...
#
 ...
 brek    = ClubPlayer.create({first_name: "Brek", last_name: "Shea", profile_name: "bshea", password: "password1", password_confirmation: "password1", email: "thing4@example.com", grad_year: "2018", position: "Midfielder", club_team: "Stoke", formation: "4-5-1", confirmed_at: Time.now})
 higuain = ClubPlayer.create({first_name: "Gonzala", last_name: "Higuan", profile_name: "gonzo", password: "password1", password_confirmation: "password1", email: "thing5@example.com", grad_year: "2015", position: "Striker", club_team: "Napoli", formation: "4-4-2", confirmed_at: Time.now})
 gatuso  = ClubPlayer.create({first_name: "Generro", last_name: "Gatuso", profile_name: "pitbull", password: "password1", password_confirmation: "password1", email: "thing6@example.com", grad_year: "2018", position: "Midfielder", club_team: "AC Milan", formation: "4-4-2", confirmed_at: Time.now})
 wayne   = ClubPlayer.create({first_name: "Wayne", last_name: "Rooney", profile_name: "r10", password: "password1", password_confirmation: "password1", email: "thing7@example.com", grad_year: "2015", position: "Striker", club_team: "Manchester United", formation: "4-3-1-2", confirmed_at: Time.now})
 vincent = ClubPlayer.create({first_name: "Vincent", last_name: "Kompany", profile_name: "vkomp", password: "password1", password_confirmation: "password1", email: "thing8@example.com", grad_year: "2016", position: "Defender", club_team: "Manchester City", formation: "4-4-2", confirmed_at: Time.now})
 cesc    = ClubPlayer.create({first_name: "Cesc", last_name: "Fabregas", profile_name: "fab10", password: "password1", password_confirmation: "password1", email: "thing9@example.com", grad_year: "2017", position: "Midfielder", club_team: "Chelsea", formation: "4-4-2", confirmed_at: Time.now})
