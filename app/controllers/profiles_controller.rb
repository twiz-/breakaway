class ProfilesController < ApplicationController
  ...
  def email_club_coach        
    ...
    if message.length >= 5
      ...
      redirect_to profile_path(params[:profile_name]), notice: "The msg couldn't be delivered, was it longer than 5 characters? Please try again later. If it happens again contact support."  
    end
  end    
